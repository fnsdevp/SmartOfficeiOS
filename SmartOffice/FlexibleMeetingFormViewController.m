//
//  FlexibleMeetingFormViewController.m
//  SmartOffice
//
...
@interface FlexibleMeetingFormViewController (){
...
@implementation FlexibleMeetingFormViewController
...
- (void)viewDidLoad {
    ...
    sdate = [dateFormatter stringFromDate:[NSDate dateWithTimeIntervalSinceNow:(24*60*60)]];
...
-(void)timeSlotSettings:(MeetingTimeCollectionViewCell *)cell2 withIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (isSelectedTime) {
        ...
        NSString *strDateTime = [NSString stringWithFormat:@"%@ %@",selectedDate,firstTime];
...
-(void)chooseDatewithTag:(int)Tag onCell:(MeetingFormCollectionViewCell *)cell
{
...
-(void)selectFlexibleDates:(MeetingFormCollectionViewCell *)cell
{
    UIButton* btn = cell.btnDate;
...
- (void)WWCalendarTimeSelectorDone:(WWCalendarTimeSelector * _Nonnull)selector date:(NSDate * _Nonnull)date{
    ...
    [dateFormatterForAPI setLocale:locale];
    ...
    if(firstDate){
        ...
        if ((compare==NSOrderedAscending)||(compare==NSOrderedSame)) {
            ...
            initialDate = [dateFormatterForAPI dateFromString:dateForAPI];
        ...
        NSDate *SecondDate = [dateFormatterForAPI dateFromString:dateForAPI];
        
        NSDate *currentDate = [dateFormatterForAPI dateFromString:[dateFormatterForAPI stringFromDate:[NSDate dateWithTimeIntervalSinceNow:(24*60*60*2)]]];
        
        NSDate *currentWeekDate = [NSDate dateWithTimeInterval:(24*60*60*7) sinceDate:currentDate];
        
        NSComparisonResult compare = [currentDate compare:SecondDate];
        
        if ((compare==NSOrderedAscending)||(compare==NSOrderedSame)) {
            
            NSDate *FDate = [dateFormatterForAPI dateFromString:fdate];
            
            NSComparisonResult compare2 = [FDate compare:SecondDate];
            ...
            if (compare2==NSOrderedAscending) {
                ...
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"You cannot select previous date to set Second date."
                                                                    message:nil
                                                                   delegate:nil
        ...
        if (compare==NSOrderedAscending) {
            ...
            if ([type isEqualToString:@"Guest"]) {
                ...
                if(([phone isEqualToString:@""])||([phone length]==0)){
                    ...
                    params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtFieldAgenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":@"",@"location":@"None"};
                    
                }else{
                    
                    params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":@"",@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtFieldAgenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":phone,@"location":@"None"};
            ...
            else
            {
                if(([phone isEqualToString:@""])||([phone length]==0)){
                    ...
                    params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtFieldAgenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":@"",@"location":locationName};
                    
                }else{
                    
                    params = @{@"contact":[[Userdefaults objectForKey:@"ProfInfo"] objectForKey:@"id"],@"department":department,@"designation":@"CEO",@"from_time":fromTime,@"to_time":toTime,@"duration":duration,@"agenda":_txtFieldAgenda.text,@"fdate":fdate,@"sdate":sdate,@"pushid_g":@"",@"phone":phone,@"location":locationName};
            ...
            [manager POST:host_url parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
                ...
                if ([success isEqualToString:@"success"]) {
                    ...
                    NSDate *Sdate = [dateFormatterForAPI dateFromString:sdate];
                    ...
                    daySel = [NSString stringWithFormat:@"%d",(int)day2];
                    
                    monthSel = [months objectAtIndex:(month2 -1)];
                    
                    yearSel = [NSString stringWithFormat:@"%d",(int)year2];
                    
                    NSUInteger characterCount2 = [daySel length];
                    ...
                    _lblDay2.text = daySel;
                    _lblMonth2.text = monthSel;
                    _lblYear2.text = yearSel;
                    
                    _lblMeetingDateTime.text = [NSString stringWithFormat:@"Meeting between"];
...
-(void)ContactsTableController:(ContactsTableController *)obj getName:(NSString *)name andphNo:(CNContact *)contact
{
    ...
    [UIView animateWithDuration:0 animations:^{
        ...
        if ([userType isEqualToString:@"Guest"]) {
            ...
            [self getEmployeeavailTimeforDate:fdate];
            
        } else {
            
            [self getUseravailTimeforDate:fdate];
        }
